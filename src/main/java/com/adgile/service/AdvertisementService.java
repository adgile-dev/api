...
import com.adgile.mapper.AdvertisementMapper;
...
public class AdvertisementService {
	...
	public AdvertisementInfoResponse getAdvertisement(Long id) {
		...
		AdvertisementInfoResponse advertisementInfoResponse = AdvertisementMapper.INSTANCE.advertisementToInfo(tuple);
		System.out.println(advertisementInfoResponse);
	...
	public AdvertisementListResponse getAdvertisements() {
		...
		List<AdvertisementInfoResponse> advertisements = AdvertisementMapper.INSTANCE.advertisementToList(tuples);
